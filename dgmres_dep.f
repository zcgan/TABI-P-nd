...
C   ------------------------------------------------------------------
      ...
      JSCAL = IGWK(3)
      JPRE = IGWK(4)
      print *,' MAXL= ',MAXL, 'N= ',N, ' KMP= ', KMP, 'JSCAL=', JSCAL
      print *,' JPRE= ',JPRE, 'ITOL=', ITOL
...
C   ------------------------------------------------------------------
      print *, 'Calculate scaled-preconditioned norm of RHS vector b'
      IF (JPRE .LT. 0) THEN
...
C   ------------------------------------------------------------------
      print *,'Use the DPIGMR algorithm to solve the A*Z = R'
...
C############################################
C Input the error at each iterative step
        print *,LL,'err= ',err
C############################################
